 ...
 * Java package.
 */
@Autonomous(name="AutonBlueNoDelayStop")
public class AutonBlueNoDelayStop extends SynchronousOpMode {
    public enum State {
    ...
    private void pushButtonSequence() {
        switch(pushButtonState) {
            ...
            case TURN1:
                ...
                break;
            case FORWARD2:
                driveForward(50d, 10000, new Callback() {
                    @Override
                    public void onComplete() {
                        //state=State.PARKING;
            ...
            case TURN2:
                ...
                break;
            case FORWARD3:
                driveForward(-25d, 10000, new Callback() {
                    @Override
                    public void onComplete() {
