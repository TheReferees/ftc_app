...
import com.thereferees.ftc_app.OpModes.lib.GyroPIDController;
 ...
 * Java package.
 */
@Autonomous(name="AutonRedNear")
public class AutonRedNear extends SynchronousOpMode {
    public enum State {
        PUSHING_BUTTON, PARKING
    }

    public enum PushButtonState {
        FORWARD1, TURN1, FORWARD2, DETECT_BUTTON, EXTEND_PUSHER, PUSH_BUTTON, RETRACT_PUSHER, FINISH, RETRACT_CLIMBER_DROP
    }
    ...
    private GyroPIDController turnPIDController;
    ...
    public void initialize() {
        ...
        turnPIDController = new GyroPIDController(gyro, GYRO_THRESHOLD, GYRO_SLOW_DOWN_START, GYRO_FINE_TUNE_START, motorTopRight, motorBottomRight, motorTopLeft, motorBottomLeft);
    ...
    private void pushButtonSequence() {
        switch(pushButtonState) {
            case FORWARD1:
                motorPickup.setPower(-PICKUP_POWER);
                driveForward(85d, 15000, new Callback() {
                    @Override
            ...
            case TURN1:
                ...
                break;
            case FORWARD2:
                driveForward(30d, 10000, new Callback() {
                    @Override
                    public void onComplete() {
                        state= State.PARKING;
